            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="../exam/process.php?action=create_exam"><i class="fa fa-dashboard fa-fw"></i> Create Exam Schedule</a>
                        </li>
						
                        <li>
                            <a href="../exam/?view=adminList"><i class="fa fa-dashboard fa-fw"></i> Exam List</a>
                        </li>
						
                        <li>
                            <a href="../user/?view=userList"><i class="fa fa-dashboard fa-fw"></i> User List</a>
                        </li>
						
                        <li>
                            <a href="../room/"><i class="fa fa-dashboard fa-fw"></i> Room List</a>
                        </li>
						
                        <li>
                            <a href="../subject/"><i class="fa fa-dashboard fa-fw"></i> Subjects List</a>
                        </li>
						
                        <li>
                            <a href="../generaleducation/process.php?action=create_exam"><i class="fa fa-dashboard fa-fw"></i>General Education List</a>
                        </li>
                        ...
                        <li>
                            <a href="../vpaa/?view=approvedList"><i class="fa fa-dashboard fa-fw"></i> Approved Exam Request</a>
                        </li>
						
                        <li>
                            <a href="../vpaa/?view=deniedList"><i class="fa fa-dashboard fa-fw"></i> Denied Exam Request</a>
                        </li>
